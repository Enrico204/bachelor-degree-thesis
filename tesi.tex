...
public static boolean shouldProceedWithService(Context ctx) {
	...
	Double expected = expectedBattery();
	Float now = Utils.getBatteryLevel(ctx);
	return now == 0 || (expected <= now && now > 15.0);
}
\end{minted}
\end{listing}
